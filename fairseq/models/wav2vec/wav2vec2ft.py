...
@dataclass
class Wav2Vec2FTConfig(FairseqDataclass):
...
@register_model("wav2vec2ft", dataclass=Wav2Vec2FTConfig)
class Wav2Vec2FTModel(BaseFairseqModel):
    def __init__(self, cfg: Wav2Vec2FTConfig):
        super().__init__()
        self.cfg = cfg
    ...
    @classmethod
    def build_model(cls, cfg: Wav2Vec2FTConfig, task=None):
    ...
    def extract_features(self, x, padding_mask=None):
        ...
        for i, layer in enumerate(self.layers):
            ...
            if not self.training or (dropout_probability > self.layerdrop):
                x, z = layer(x, length_mask=length_mask)
